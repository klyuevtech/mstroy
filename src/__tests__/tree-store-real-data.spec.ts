...
describe('TreeStore with real data', () => {
  ...
  describe('addItem', () => {
    it('should add a new item to the store', () => {
      const newItem: ItemType = { id: 9, parent: 1, label: 'Новый Айтем' }
  ...
  describe('updateItem', () => {
    it('should update an existing item', () => {
      const updatedItem: ItemType = { id: 3, parent: 2, label: 'Обновленный Айтем' }
    ...
    it('should not modify the array when updating a non-existent item', () => {
      ...
      const nonExistentItem: ItemType = { id: 999, parent: 1, label: 'Несуществующий Айтем' }
